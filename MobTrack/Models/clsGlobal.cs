...
namespace IOCLAndroidApp
{
    ...
    {
        public static string FileFolder = "MobTrack";
        public static string ItemFileName = "report.csv";
        public static string DBFileName = "MobTrackDB.db3";
        public static string FilePath = global::Android.OS.Environment.ExternalStorageDirectory.AbsolutePath;
        public static string DBFilePath = "";

        public static string ServerIpFileName = "";
